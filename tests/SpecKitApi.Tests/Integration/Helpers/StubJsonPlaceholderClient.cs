...
public sealed class StubJsonPlaceholderClient : IJsonPlaceholderClient
{
    ...
    [
        new PhotoDto
        {
            ...
            AlbumId = 1,
            Title = "Photo 1a",
            Url = "https://example.com/1a.jpg",
            ThumbnailUrl = "https://example.com/1a_t.jpg",
        },
        new PhotoDto
        {
            Id = 2,
            AlbumId = 1,
            Title = "Photo 1b",
            Url = "https://example.com/1b.jpg",
            ThumbnailUrl = "https://example.com/1b_t.jpg",
        },
        new PhotoDto
        {
            Id = 3,
            AlbumId = 2,
            Title = "Photo 2a",
            Url = "https://example.com/2a.jpg",
            ThumbnailUrl = "https://example.com/2a_t.jpg",
        },
        new PhotoDto
        {
            Id = 4,
            AlbumId = 2,
            Title = "Photo 2b",
            Url = "https://example.com/2b.jpg",
            ThumbnailUrl = "https://example.com/2b_t.jpg",
        },
        new PhotoDto
        {
            Id = 5,
            ...
            ThumbnailUrl = "https://example.com/3a_t.jpg",
        },
        new PhotoDto
        {
            Id = 6,
            ...
            ThumbnailUrl = "https://example.com/3b_t.jpg",
        },
    ];

    public Task<IReadOnlyList<AlbumDto>> GetAlbumsAsync(
    ...
    public Task<IReadOnlyList<PhotoDto>> GetPhotosAsync(
        CancellationToken cancellationToken = default
    )
    {
        if (ThrowOnCall)
