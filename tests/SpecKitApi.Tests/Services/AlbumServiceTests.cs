...
{
    private static AlbumService CreateService(IJsonPlaceholderClient client) =>
        new AlbumService(client);
    ...
    private static IReadOnlyList<PhotoDto> PhotosForTwoAlbums() =>
        [
            ...
            new PhotoDto
            {
                ...
                ThumbnailUrl = "https://example.com/t4.jpg",
            },
        ];
    ...
    public async Task GetAlbumsWithPhotosAsync_AssignsCorrectPhotosToEachAlbum()
    {
        ...
        mockClient
            .Setup(c => c.GetAlbumsAsync(It.IsAny<CancellationToken>()))
            .ReturnsAsync(TwoUserAlbums());
        mockClient
            .Setup(c => c.GetPhotosAsync(It.IsAny<CancellationToken>()))
            .ReturnsAsync(PhotosForTwoAlbums());
        ...
        mockClient
            ...
            .ReturnsAsync([
                new PhotoDto
                {
                    Id = 1,
                    AlbumId = 1,
                    Title = "Photo for different album",
                    Url = "",
                    ThumbnailUrl = "",
                },
            ]);
    ...
    public async Task GetAlbumsWithPhotosByUserAsync_ReturnsEmpty_WhenNoAlbumsForUser()
    {
        ...
        mockClient
            .Setup(c => c.GetPhotosAsync(It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<PhotoDto>());
        var service = CreateService(mockClient.Object);
