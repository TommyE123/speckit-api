...
- [ ] CHK044 - Is there a task that implements the sticky PR comment step from FR-022 (`marocchino/sticky-pull-request-comment@v3.0.4`, `recreate: true`, event-gated to `pull_request`)? No task in tasks.md describes this step. [Completeness, Gap, Spec §FR-022]
